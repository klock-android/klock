...
define i32 @main() #0 {
entry:
  %0 = load i32** @a, align 8, !dbg !25
  call void (i32*, ...)* bitcast (void ()* @getTIssue1 to void (i32*, ...)*)(i32* %0) #2, !dbg !25
  %call = call i8* @klock_getT2() #2, !dbg !26
  %1 = bitcast i8* %call to i32*, !dbg !26
  %2 = load i32** @a, align 8, !dbg !27
  %3 = load i32* %2, align 4, !dbg !27
  %4 = load i32* %1, align 4, !dbg !27
...
!11 = metadata !{i32 786473, metadata !1}         ; [ DW_TAG_file_type ] [/export2/jindal0/kint/test/cases/try-global.c]
...
!23 = metadata !{i32 786443, metadata !1, metadata !10} ; [ DW_TAG_lexical_block ] [/export2/jindal0/kint/test/cases/try-global.c]
...
!27 = metadata !{i32 11, i32 0, metadata !14, null}
